...
class Main(tk.Frame):
    ...
    def init_main(self):
        ...
        self.tree.column('tel', width=160, anchor=tk.CENTER)
    ...
    def edit_records(self, name, tel, email, salary):
    ...
    def delete_records(self):
        #проходим циклом по всм выделенным строкам в таблице
...
class Update(Child):
    ...
    def init_edit(self):
        ...
        self.btn_ok = tk.Button(self, text='Изменить')
        self.btn_ok.bind('<Button-1>', 
                         lambda ev: self.view.edit_records(
                             self.entry_name.get(),
                             self.entry_tel.get(),
                             self.entry_email.get(),
                             self.entry_salary.get()
...
class Search(tk.Toplevel):
    ...
    def init_search(self):
        ...
        #запрет на изменение размеров
        self.resizable(False, False)
        #перезватаваем все события приложения
        self.grab_set()
        #захватываем фокус
        self.focus_set() 
